...
- 아래의 사진 처럼 하나씩 추가하다 보면 `front == (rear+1) % SIZE` 인 상황이 발생하는데 큐가 가득한 경우이다.
...
**Dequeue(q)**
![cq0](https://github.com/dooooooooong/dooooooooong.github.io/blob/master/assets/images/markdown_images/CS/datastructure/2021-06-13-queue/cq0.jpg?raw=true)
